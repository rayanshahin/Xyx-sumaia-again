...
public class myclass {
	...
	public static void main(String[] args) throws IOException {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3));//to wait 3 secounds 
		...
		/*
		 * Date mydateeeeee = new Date(); //Date timestamp = new Date();
		 * System.out.println(mydateeeeee);
		 */
	}
